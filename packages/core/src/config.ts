...
export function mergeConfig(
  ...
  return {
    ...
    larkAppSecret: cliOptions.larkAppSecret ?? localConfig.larkAppSecret ?? globalConfig.larkAppSecret,
    ...
    taskTimeoutMs: cliOptions.taskTimeoutMs ?? localConfig.taskTimeoutMs ?? globalConfig.taskTimeoutMs ?? 600000,
  };
}
